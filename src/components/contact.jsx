  ...
  return (
    <>
      <div className="max-w-full" id="contact">
        <h1 className="font-semibold text-2xl md:text-3xl text-center pb-3">CONTACT US</h1>
        <div className="w-full flex justify-center px-4 md:px-0">
          <div className="bg-pink-100 w-full max-w-[600px] p-6 md:p-8 rounded-lg shadow-lg space-y-6 transform transition-all duration-300 hover:shadow-2xl h-auto md:h-[550px]">
