...
function about() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-indigo-100" id="about">
      {/* Banner Section */}
      <div className="relative w-screen pt-2 overflow-hidden">
        <img
          src={Banner}
          alt="Banner"
          className="w-screen h-[350px] object-cover transition-transform duration-500 hover:scale-110"
        />
      ...
      <div className="max-w-full mx-auto bg-slate-100 py-8 font-semibold">
        <div className="flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-60">
      ...
      <div className="relative max-w-[1100px] mx-auto bg-slate-100 py-8 px-6 font-semibold pt-10 mt-5 text-pretty space-y-8 border border-gray-300 rounded-lg overflow-hidden shadow-xl">
        ...
        <div className="text-center relative z-10">
          <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">WHY WE NEED TO DO IT?</h1>
        ...
        <div className="text-center relative z-10">
          <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">OUR VISION</h1>
          <p className="text-xl md:text-2xl font-semibold text-gray-700 mt-4">
