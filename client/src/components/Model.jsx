  ...
  return (
    <>
      <div className="w-screen pt-2 bg-slate-100" id="model">
        <h1 className="text-black text-center text-2xl sm:text-3xl font-semibold mt-1">
          Here's How Our Model Works!
        </h1>

        <div className="mt-8 max-w-[1320px] mx-auto px-4">
          <h1 className="text-lg sm:text-xl md:text-2xl text-justify leading-relaxed">
            1. <b>CCTV Integration:</b> The system is integrated with existing CCTV cameras, continuously monitoring public spaces for any unusual or harmful activity.
            <br /><br />
            2. <b>Live Video Analysis:</b> The AI model analyzes the live video feed in real-time, using action recognition and anomaly detection techniques to identify behaviors that could indicate danger, such as physical violence or harassment.
            <br /><br />
            3. <b>Anomaly Detection:</b> When the model detects abnormal behavior, it flags it as a potential threat, triggering the next step.
            <br /><br />
            4. <b>Real-time Alerts:</b> Once a potential threat is identified, the system sends immediate alerts to the nearest police station and nearby individuals, providing the location for quick response.
            <br /><br />
            5. <b>Proactive Intervention:</b> Unlike traditional surveillance that acts after an incident, this model aims to prevent harm by enabling real-time intervention before an incident escalates.
          </h1>
        </div>
        ...
        {showAlert && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center w-full max-w-[500px]">
